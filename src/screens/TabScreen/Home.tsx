...
const products = [
    { id: '1', name: 'Cappuccino', description: 'with chocolate', image: require('../../../assets/Cappucino.png'), price: '$4.53', rating: 4.8 },
    { id: '2', name: 'Latte', description: 'with chocolate', image: require('../../../assets/Latte.png'), price: '$3.90', rating: 4.9 },
    ...
    return (
        <ScrollView style={{ backgroundColor: "black" }} contentContainerStyle={styles.container}>
            <View style={styles.header}>
                ...
                <Image source={require("../../../assets/pp.png")} style={styles.avatar} />
            </View>
