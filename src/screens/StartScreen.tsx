  ...
  return (
    <View
      ...
      <View>
        ...
        <Text style={{fontSize:30, color:"white", paddingHorizontal:30, textAlign:"center", fontFamily:"fantasy",}}>Coffee so good, your taste buds will love it.</Text>
        <Text style={{color:"#A9A9A9", textAlign:"center",marginTop:-1 }}>
